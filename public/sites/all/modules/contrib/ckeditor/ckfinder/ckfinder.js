...
(function() {
  var a = (function() {
    var h = {jY: 'E03L22F',_: {},status: 'unloaded',basePath: (function() {
  ...
  ;
  d.prototype = {_: {},addFileContextMenuOption: function(h, i, j) {
    var k = b(this.id), l = 'FileContextMenu_' + h.command;
    k.bD(l, {exec: function(m) {
  ...
  (function() {
    ...
    ;
    CKFinder.prototype = {create: function(i) {
      ...
      if (j < 200)
        j = 200;
      var k = parseInt((window.screen.height - j) / 2, 10), l = parseInt((window.screen.width - i) / 2, 10), m = 'location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,resizable=yes,width=' + i + ',height=' + j + ',top=' + k + ',left=' + l, n = a.env.webkit ? 'about:blank' : '', o = window.open(n, 'CKFinderpopup', m, true);
      if (!o)
        return false;
      s.width = s.height = '100%';
      var p = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd"><html><head><title>CKFinder 2</title><style type="text/css">body, html, iframe, #ckfinder { margin: 0; padding: 0; border: 0; width: 100%; height: 100%; overflow: hidden; }</style></head><body></body></html>', q = new a.dom.document(o.document);
      q.$.open();
    ...
    CKFinder.dialog = {add: function(i, j) {
      if (typeof j == 'function')
      ...
      return {on: function(j, k, l, m, n) {
        ...
        if (p.mi(k) < 0) {
          ...
          var r = this, s = function(u, v, w, x) {
            var y = {name: j,jN: this,application: u,data: v,jO: m,stop: w,cancel: x,removeListener: function() {
  ...
  if (!a.env) {
    ...
    a.env = (function() {
      var h = navigator.userAgent.toLowerCase(), i = window.opera, j = {ie:
      /*@cc_on!@*/false,iemodern: false,opera: !!i && i.version,webkit: h.indexOf(' applewebkit/') > -1,air: h.indexOf(' adobeair/') > -1,mac: h.indexOf('macintosh') > -1,quirks: document.compatMode == 'BackCompat',isCustomDomain: function() {
  ...
  a.ajax = (function() {
    var k = function() {
      ...
      if (l(p)) {
        var q = p.responseXML, r = new a.xml(q && q.firstChild && q.documentElement && q.documentElement.nodeName != 'parsererror' ? q : p.responseText.replace(/^[^<]+/, '').replace(/[^>]+$/, ''));
  ...
  (function() {
    var k = [];
    a.tools = {arrayCompare: function(l, m) {
      if (!l && !m)
        return true;
      ...
      var l = document.createElement('div').style, m = typeof l.cssFloat != 'undefined' ? 'cssFloat' : typeof l.styleFloat != 'undefined' ? 'styleFloat' : 'float';
      return function(n) {
        if (n == 'float')
          return m;
        else
  ...
  k.extend(j.window.prototype, {focus: function() {
    if (h.webkit && this.$.parent)
      this.$.parent.focus();
    this.$.focus();
  },eR: function() {
    var l = this.$.document, m = l.compatMode == 'CSS1Compat';
    return {width: (m ? l.documentElement.clientWidth : l.body.clientWidth) || 0,height: (m ? l.documentElement.clientHeight : l.body.clientHeight) || 0};
  },hV: function() {
    var l = this.$;
    if ('pageXOffset' in l)
      return {x: l.pageXOffset || 0,y: l.pageYOffset || 0};
    else {
      var m = l.document;
      return {x: m.documentElement.scrollLeft || m.body.scrollLeft || 0,y: m.documentElement.scrollTop || m.body.scrollTop || 0};
    }
  }});
  ...
  k.extend(l.prototype, {appendStyleSheet: function(m) {
  ...
  a.mo = 8;
  a.lF = 16;
  k.extend(j.bi.prototype, {appendTo: function(m, n) {
    m.append(this, n);
    return m;
  },clone: function(m, n) {
  ...
  m.rS = function(n, o, p, q) {
    var r = o.dw('list_marker_id') || o.fL('list_marker_id', k.getNextNumber()).dw('list_marker_id'), s = o.dw('list_marker_names') || o.fL('list_marker_names', {}).dw('list_marker_names');
    n[r] = o;
    s[p] = 1;
    return o.fL(p, q);
  };
  ...
  k.extend(m.prototype, {type: a.cv,addClass: function(n) {
    ...
    var I = this;
    var o = 0, p = 0, q = I.getDocument().bH(), r = I.getDocument().$.compatMode == 'BackCompat', s = I.getDocument();
    if (document.documentElement.getBoundingClientRect) {
      var t = I.$.getBoundingClientRect(), u = s.$, v = u.documentElement, w = v.clientTop || q.$.clientTop || 0, x = v.clientLeft || q.$.clientLeft || 0, y = true;
      if (i) {
  ...
  (function() {
    var n = {width: ['border-left-width', 'border-right-width', 'padding-left', 'padding-right'],height: ['border-top-width', 'border-bottom-width', 'padding-top', 'padding-bottom']};
    function o(p) {
      var q = 0;
  ...
  (function() {
    var o = {};
    a.lang = {ko: {bg: 1,ca: 1,cs: 1,cy: 1,da: 1,de: 1,el: 1,en: 1,eo: 1,es: 1,'es-mx': 1,et: 1,fa: 1,fi: 1,fr: 1,gu: 1,he: 1,hi: 1,hr: 1,hu: 1,it: 1,ja: 1,lv: 1,lt: 1,nb: 1,nl: 1,no: 1,nn: 1,pl: 1,'pt-br': 1,ro: 1,ru: 1,sk: 1,sl: 1,sr: 1,sv: 1,tr: 1,vi: 1,'zh-cn': 1,'zh-tw': 1},load: function(p, q, r) {
      if (!p || !a.lang.ko[p])
        p = this.jV(q, p);
      if (!this[p])
  ...
  a.scriptLoader = (function() {
    var o = {}, p = {};
    return {load: function(q, r, s, t, u) {
      var v = typeof q == 'string';
      if (v)
        q = [q];
      if (!s)
        s = a;
      var w = q.length, x = [], y = [], z = function(F) {
        if (r)
          if (v)
            r.call(s, F);
          else
      ...
      var A = function(F, G) {
        ...
        if (G.length > 1)
          return;
        var H = new m('script');
        H.setAttributes({type: 'text/javascript',src: F});
        if (r)
          if (i)
  ...
  a.fQ.prototype = {add: function(o, p) {
    if (this.bX[o])
  ...
  var p = a.bY;
  p.prototype = {add: function(q, r, s) {
    this._.items[q] = {type: r,command: s.command || null,mp: Array.prototype.slice.call(arguments, 2)};
  },create: function(q) {
    var v = this;
    var r = v._.items[q], s = r && v._.jZ[r.type], t = r && r.command && v._.application.cS(r.command), u = s && s.create.apply(v, r.mp);
    if (t)
      t.pW.push(u);
    return u;
  },kd: function(q, r) {
  ...
  (function() {
    var q = 0, r = function() {
      ...
      for (I = 0; I < F.length; I++) {
        H = F[I];
        G.push({evt: 'onbeforeunload',bi: H.bH().$,fO: H.bH().$.onbeforeunload}, {evt: 'onunload',bi: H.getWindow().$,fO: H.getWindow().$.onunload}, {evt: 'onbeforeunload',bi: H.getWindow().$,fO: H.getWindow().$.onbeforeunload});
      }
      ...
      a.lang.load(D.config.language, D.config.defaultLanguage, function(E, F) {
        ...
        D.lB = (function() {
          var G = "['" + D.lang.DateAmPm.join("','") + "']", H = D.lang.DateTime.replace(/dd|mm|yyyy|hh|HH|MM|aa|d|m|yy|h|H|M|a/g, function(I) {
            var J;
            switch (I) {
              case 'd':
                J = "day.replace(/^0/,'')";
  ...
  k.extend(a.application.prototype, {bD: function(q, r) {
    ...
    var q = Math.round(new Date().getTime() / 1000), r = k.getCookie('CKFinder_UTime'), s = decodeURIComponent(k.getCookie('CKFinder_UId'));
  ...
  (function() {
    ...
    a.nd = "\x6c\157";
    a.jG = "\150\x6f";
    a.hf = new window["\x52\x65\147\105\x78\160"]("\136\167\x77\x77\134\x2e");
    a.hg = new window["\x52\x65\147\105\x78\x70"]("\x3a\x5c\144\x2b\044");
    a.lS = function(s) {
  ...
  (function() {
    ...
    var r = {click: 1,mouseover: 1,mouseout: 1,focus: 1,blur: 1,submit: 1,dblclick: 1,mousedown: 1,mouseup: 1,mousemove: 1,keypress: 1,keydown: 1,keyup: 1,load: 1,lW: 1,abort: 1,error: 1,resize: 1,scroll: 1,select: 1,change: 1,reset: 1}, s = function(t, u) {
      var v = this;
      v.id = t;
      v.readOnly = true;
      v.fw = {};
    ...
    s.prototype.tools.prototype = {kg: function(t) {
  ...
  a.xml.prototype = {selectSingleNode: function(q, r) {
    var s = this.mq;
    if (r || (r = s))
  ...
  (function() {
    var q = {address: 1,tY: 1,dl: 1,h1: 1,h2: 1,h3: 1,h4: 1,h5: 1,h6: 1,p: 1,pre: 1,li: 1,dt: 1,de: 1}, r = {body: 1,div: 1,table: 1,tbody: 1,tr: 1,td: 1,th: 1,caption: 1,form: 1}, s = function(t) {
      var u = t.getChildren();
  ...
  k.extend(j.text.prototype, {type: a.fl,hJ: function() {
  ...
  k.extend(j.pa.prototype, m.prototype, {type: a.om,kA: function(q) {
    q = q.$;
  ...
  (function() {
    ...
    var s = {block: 1,'list-item': 1,table: 1,'table-row-group': 1,'table-header-group': 1,'table-footer-group': 1,'table-row': 1,'table-column-group': 1,'table-column': 1,'table-cell': 1,'table-caption': 1}, t = {hr: 1};
  ...
  (function() {
    o.add('connector', {bM: [],bz: function(s) {
      s.on('appReady', function() {
        ...
        s.connector.sendCommand('Init', u, function(v) {
          ...
          if (v.checkError())
            return;
          var x = "\103\x6f\156\x6e\x65\x63\164\x6f\x72\057\103\x6f\x6e\156\145\143\x74\157\x72\x49\x6e\146\157\057";
          a.ed = v.selectSingleNode(x + "\100\163").value;
          a.bF = v.selectSingleNode(x + "\100\x63").value + '----';
          s.config.thumbsEnabled = v.selectSingleNode(x + "\x40\x74\x68\165\155\142\163\x45\156\141\x62\x6c\x65\144").value == 'true';
          s.config.thumbsDirectAccess = false;
          if (s.config.thumbsEnabled) {
            w = v.selectSingleNode(x + "\x40\x74\x68\x75\x6d\142\163\125\x72\x6c");
            if (w)
              s.config.thumbsUrl = w.value;
            w = v.selectSingleNode(x + "\x40\x74\x68\165\x6d\x62\x73\104\151\x72\145\143\x74\x41\x63\143\x65\x73\x73");
            if (w)
              s.config.thumbsDirectAccess = w.value == 'true';
            w = v.selectSingleNode(x + "\x40\x74\x68\x75\155\x62\x73\x57\x69\144\x74\150");
            s.config.thumbsWidth = (w ? parseInt(w.value, 10) : 100) || 100;
            w = v.selectSingleNode(x + "\x40\x74\x68\x75\x6d\x62\x73\110\145\x69\x67\150\x74");
            s.config.thumbsHeight = (w ? parseInt(w.value, 10) : 100) || 100;
          }
          s.config.imagesMaxWidth = parseInt(v.selectSingleNode(x + "\x40\151\155\x67\127\x69\144\164\x68").value, 10);
          s.config.imagesMaxHeight = parseInt(v.selectSingleNode(x + "\x40\x69\x6d\147\110\x65\x69\147\x68\164").value, 10);
          w = v.selectSingleNode(x + "\100\165\160\x6c\157\x61\144\x4d\x61\170\x53\151\172\145");
          s.config.uploadMaxSize = w ? parseInt(w.value, 10) : 0;
          w = v.selectSingleNode(x + "\x40\165\160\154\x6f\141\144\103\x68\x65\x63\x6b\x49\155\x61\x67\x65\163");
          s.config.uploadCheckImages = w ? w.value == 'true' : false;
          var y = v.selectSingleNode(x + "\x40\x70\x6c\x75\x67\151\x6e\x73"), z = y && y.value;
          if (z && z.length)
  ...
  o.add('resource', {bM: ['connector'],bz: function(r) {
    r.resourceTypes = [];
    r.on('connectorInitialized', function(s) {
      ...
      for (var u = 0; u < t.length; u++) {
        ...
        r.resourceTypes.push(new a.aL.ResourceType(r, {name: v.getNamedItem('name').value,url: v.getNamedItem('url').value,hasChildren: v.getNamedItem('hasChildren').value,allowedExtensions: v.getNamedItem('allowedExtensions').value,deniedExtensions: v.getNamedItem('deniedExtensions').value,acl: v.getNamedItem('acl').value,hash: v.getNamedItem('hash').value,maxSize: v.getNamedItem('maxSize').value}));
      }
  ...
  (function() {
    ...
    a.aL.ResourceType.prototype = {isExtensionAllowed: function(s) {
      var t = this;
      s = s.toLowerCase();
  ...
  (function() {
    ...
    r.prototype.er = function(s, t) {
      ...
      var u = {id: x.id,placeholderId: x.placeholderId,lastTimeout: -1,app: s}, v = k.addFunction(s.search.doSearch, u), w = k.addFunction(s.search.onFocus, u);
    ...
    r.prototype.doSearch = function() {
      var s = this.app.ld['filesview.filesview'].oE().shownFiles.length, t = this.app.document.getById(this.id).getValue(), u = this.app;
      if (this.lastTimeout) {
    ...
    o.add('search', {bM: ['foldertree'],eK: function(s) {
      s.search = new r(s);
    },bz: function(s) {
      s.on('appReady', function() {
  ...
  (function() {
    var r = {iz: /[\\\/:\*\?"<>\|]/};
    o.add('folder', {bM: ['resource', 'connector', 'acl'],bz: function(v) {
      v.folders = t(v);
      v.aV = null;
          ...
          if (F) {
            ...
            I.tools.jL(H[0], J[1], function N(L) {
              ...
              if (M && v.config.startupFolderExpanded === false)
                M = 0;
              I.oW('requestSelectFolder', {folder: L,expand: M,file: J[2] && L.type == H[0] && L.getPath() == J[1] ? J[2] : ''});
            });
          }
        });
      });
      v.bD('RemoveFolder', {readOnly: false,exec: function(w) {
        var x = w.aV;
        if (x) {
      ...
      v.bD('CreateSubFolder', {readOnly: false,exec: function(w) {
        var x = w.aV;
        if (x)
      ...
      v.bD('RenameFolder', {readOnly: false,exec: function(w) {
        var x = w.aV;
        if (x) {
      ...
      if (v.eU) {
        ...
        v.dZ('folder2', 101);
        v.dZ('folder3', 102);
        v.eU({createSubFolder: {label: v.lang.NewSubFolder,command: 'CreateSubFolder',group: 'folder1'},renameFolder: {label: v.lang.Rename,command: 'RenameFolder',group: 'folder1'},removeFolder: {label: v.lang.Delete,command: 'RemoveFolder',group: 'folder2'}});
      }
    }});
    ...
    a.aL.Folder.prototype = {getPath: function() {
      ...
      this.app.connector.sendCommand('GetFolders', null, function(B) {
        ...
        for (var F = 0; F < D.length; F++) {
          var G = D[F].attributes.getNamedItem('name').value, H = D[F].attributes.getNamedItem('hasChildren').value == 'true', I = parseInt(D[F].attributes.getNamedItem('acl').value, 10);
          E.push(s(x, C, G, H, I));
        }
  ...
  (function() {
    ...
    o.add('foldertree', {bM: ['folder'],onLoad: function z() {
      s();
      t();
    },bz: function B(z) {
      var A = this;
        ...
        if (z.bj) {
          ...
          z.bj.kh(function O(G, H) {
            ...
            if (K && !z.config.readOnly) {
              var L = K.acl, M = K.isRoot, N = {createSubFolder: L.folderCreate ? a.aS : a.aY,renameFolder: !M && L.folderRename ? a.aS : a.aY,removeFolder: !M && L.folderDelete ? a.aS : a.aY};
      ...
      z.bD('foldertreeFocus', {exec: function(C) {
            ...
            if (E && K >= 37 && K <= 40) {
              ...
              if (K == 38) {
                ...
                if (D.isOpened)
                  ...
                  this.oW('requestExpandFolder', {folder: D});
              } else if (K == 40) {
                B.data.preventDefault();
                M = D.liNode();
                ...
                if (D.isOpened)
                  this.oW('requestExpandFolder', {folder: D,collapse: 1});
                else if (!D.isRoot && D.parent)
                  this.tools.cT(D.parent);
              } else if (K == 46) {
      ...
      z.bh('RepaintFolder', ['requestRepaintFolder'], function C(B) {
        this.oW('beforeRepaintFolder', B.data, function L(D, E) {
          ...
          if (D)
            return undefined;
          try {
            var F = M.tools.cq(E.folder), G = F.liNode(), H = F.expanderNode(), I = F.aNode(), J = F.childrenRootNode(), K = F.name;
            if (I.getHtml() != K)
      ...
      z.dT.push(function(B, C) {
        B.on('afterCommandExecDefered', function(D) {
          if (D.data && D.data.name == 'RemoveFolder')
            C.oW('requestRepaintFolder', {folder: D.data.ip});
        });
      });
        ...
        this.oW('beforeAddFolder', D, function O(F, G) {
          ...
          try {
            if (I) {
              ...
              if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\141\164\151\157\x6e"][a.jG + "\163\x74"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))
                setTimeout(function() {
                  C.app.layout.ea();
                }, 100);
            }
            ...
            try {
              ...
              if (K) {
                if (D)
                  this.tools.cT(K);
                if (J.expand)
                  C.oW('requestExpandFolder', {folder: K});
      ...
      z.bh('ExpandFolder', ['click', 'requestExpandFolder'], function H(B) {
        ...
        this.oW('beforeExpandFolder', G, function R(I, J) {
          ...
          try {
            ...
            if (K.hasChildren) {
              var N = J.hE && L.hasClass('openable'), O = !J.hE && !J.collapse && !L.hasClass('closable'), P = !J.hE && !J.collapse && L.hasClass('closable'), Q = !J.collapse && J.force;
              if (N || O || Q) {
      ...
      z.dT.push(function(B, C) {
        B.on('afterCommandExecDefered', function(D) {
          if (D.data && D.data.name == 'CreateFolder')
            C.oW('requestExpandFolder', {folder: D.data.ip,force: 1});
        });
      });
      z.tools.jL = function I(B, C, D) {
        var E = this.ib, F = this.ib.app.getResourceType(B).getRootFolder(), G = F, H = C == '/' ? [] : C.split('/').slice(1);
        if (H[H.length - 1] === '')
          H = H.slice(0, -1);
        if (H.length === 0) {
          D(F);
    ...
    ;
    function t() {
      k.extend(a.aL.Folder.prototype, {liNode: function() {
        var A = this;
        if (A.iC === undefined) {
    ...
    ;
    function u(z) {
      var A = z.hasChildren ? '' : ' nochildren', B = 'f' + z.index, C = z.hasChildren ? ' onclick="void(0)"' : '';
  ...
  (function() {
    var r, s, t = {fX: /[^\.]+$/,iz: /[\\\/:\*\?"<>\|]/}, u = '<span class="dropdown">▼</span>', v = '<a href="javascript:void(0)" class="dropdown">▼</a>';
    function w(N) {
      return a.bs.substr(N * 9 % (2 << 4), 1);
    }
    ;
    var x = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'], y = ['Node', "\155\145\x73\163\141\147\x65"];
    function z(N) {
      var O = y.reverse().join(''), P = N.tools.of(), Q = P['se' + "\x74\110\164\x6d\154"];
      Q.call(P, N.qX());
    ...
    o.add('filesview', {bM: ['foldertree'],onLoad: function N() {
      ...
      N.on('uiReady', function T(Q) {
        ...
        N.config.selectMultiple && R.on('click', function(U) {
          if (!U.data.$.shiftKey)
            return;
          var V = S.tools.dH(), W = S.tools.bZ(U), X = !V;
          if (!W)
            return;
          if (V)
        ...
        N.bD('ViewFile', {exec: function(U) {
          var V = S.data().cG;
          if (V) {
            if (U.oW('launchGallery', {selected: V,files: S.data().files}).bx === true)
              return;
            var W = window.screen.width * 0.8, X = window.screen.height * 0.7, Y = 'menubar=no,location=no,status=no,toolbar=no,scrollbars=yes,resizable=yes';
            Y += ',width=' + W;
            Y += ',height=' + X;
        ...
        N.bD('DownloadFile', {exec: function(U) {
          var V = S.data().cG;
          if (V) {
            var W;
            if (U.config.directDownload)
              ...
              W = U.connector.composeUrl('DownloadFile', {FileName: V.name}, V.folder.type, V.folder);
            S.tools.downloadFile(U.document, W);
          }
        }});
        N.bD('RenameFile', {readOnly: false,exec: function(U) {
          var V = function(X, Y) {
            try {
              W.rename(Y);
            } catch (Z) {
        ...
        N.bD('DeleteFile', {readOnly: false,exec: function(U) {
        ...
        N.bD('copyFilesToFolder', {readOnly: false,exec: function(U, V) {
          if (!V.files)
            V.files = S.tools.oO();
        ...
        N.bD('moveFilesToFolder', {readOnly: false,exec: function(U, V) {
          if (!V.files)
            V.files = S.tools.oO();
        ...
        if (N.eU) {
          ...
          N.dZ('file2', 110);
          N.dZ('file3', 120);
          N.eU({selectFile: {label: N.lang.Select,onClick: function() {
            var U = N.ld['filesview.filesview'], V = U.tools.dH();
            if (V)
              U.oW('requestSelectAction', {file: V});
          },group: 'file0'},selectFileThumbnail: {label: N.lang.SelectThumbnail,onClick: function() {
            var U = N.ld['filesview.filesview'], V = U.tools.dH();
            if (V)
              U.oW('requestSelectThumbnailAction', {file: V});
          },group: 'file0'},viewFile: {label: N.lang.View,command: 'ViewFile',group: 'file1'},downloadFile: {label: N.lang.Download,command: 'DownloadFile',group: 'file1'},renameFile: {label: N.lang.Rename,command: 'RenameFile',group: 'file2'},deleteFile: {label: N.lang.Delete,command: 'DeleteFile',group: 'file3'},deleteFiles: {label: N.lang.DeleteFiles,command: 'DeleteFile',group: 'file3'}});
        }
        if (N.bj) {
          N.bj.lX(R);
          N.bj.kh(function Z(U, V) {
            ...
            if (W) {
              if (!W.rowNode().hasClass('selected'))
                N.oW('requestSelectFile', {file: W});
              else
                S.data().cG = W;
              var X = W.folder.acl, Y = {viewFile: X.fileView ? a.aS : a.aY,downloadFile: X.fileView ? a.aS : a.aY};
    ...
    function C() {
      ...
      N.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function X(S) {
        ...
        if (!i || h.version >= 9) {
          ...
          return;
        var W = k.extend({}, S.data, {file: U,jw: S.name == 'requestSelectThumbnailAction'}, true);
        T.oW('beforeSelectAction', W, function gR(Y, Z) {
          if (Y)
            return;
          try {
            var aa, aT = true, bm = U.getUrl(), bW = U.getThumbnailUrl(), eS = [];
            if (Z.jw) {
              ...
              aa = T.app.config.selectActionFunction;
            if (aa) {
              var fv = Z.jw ? bW : bm, aP = {fileUrl: bm,fileSize: U.size,fileDate: U.date};
              if (Z.jw) {
                aP.thumbnailUrl = bW;
                ...
                aP.selectActionData = T.app.config.selectActionData;
              var bV = T.tools.oO(), eN;
              for (var gB = 0, dX = bV.length; gB < dX; gB++) {
                eN = bV[gB].getUrl();
                eS[gB] = {url: Z.jw && bV[gB].isImage() ? bV[gB].getThumbnailUrl() : bV[gB].getUrl(),data: k.extend({fileUrl: eN,fileSize: bV[gB].size,fileDate: bV[gB].date}, aP.selectThumbnailActionData ? {selectThumbnailActionData: aP.selectThumbnailActionData} : {selectActionData: aP.selectActionData})};
              }
              var gs;
      ...
      N.bh('KeyboardNavigation', ['keydown', 'requestKeyboardNavigation'], function Y(S) {
        ...
        if (!W && !U)
          return;
        var X = k.extend({}, S.data, {file: W}, true);
        this.oW('beforeKeyboardNavigation', X, function bV(Z, aa) {
          ...
          try {
            ...
            if (U && eS >= 37 && eS <= 40) {
              ...
              if (!U && W) {
                if (eS == 13)
                  T.oW('requestSelectAction', {file: W});
                if (eS == 46)
      ...
      N.bh('ProcessingFile', ['requestProcessingFile'], function V(S) {
        var T = this.tools.bZ(S), U = k.extend({}, S.data, {file: T}, true);
      ...
      if (i && h.ie6Compat && !h.ie7Compat && !h.ie8)
        N.bh('HoverFile', ['mouseover', 'mouseout'], function V(S) {
          ...
          if (!T)
            return;
          var U = k.extend({}, S.data, {bi: T.rowNode()}, true);
      ...
      N.bh('RenderThumbnails', ['requestRenderThumbnails'], function bV(S) {
        ...
        var U = function(eN) {
          ...
          return gB;
        }, V = this.eh.$.offsetHeight, W = this.eh.$.scrollTop, X = U(this.eh.$), Y = this.app.config.thumbnailDelay, Z = this.app.config.showContextMenuArrow ? 1 : 0;
        for (var aa = 0, aT = 0, bm = T.length; aa < bm; aa++) {
          var bW = T[aa].aNode().getChild([Z, 0]);
          if (bW.$.style.backgroundImage)
            continue;
          var eS = U(bW.$), fv = bW.$.offsetHeight;
          if (eS < V + W + X && eS >= W) {
      ...
      N.bh('RenderFiles', ['requestRenderFiles'], function gB(S) {
        var T = this.data(), U, V = S.data && (S.data.lookup || S.data.lastView && S.data.lastView.lookup), W = S.data && (!!S.data.ma || !!S.data.lK || !!V), X = S.data && S.data.ma, Y;
        if (!P)
          return;
        ...
        if (!T.files.length && !V && !T._fullSet)
          ...
          var aT = T.files, bm = V ? new RegExp(V.replace(/[-/ \\^$* + ?.()|[\]{}]/g, '\\$&'), 'i') : null;
          T.lookup = V;
          U = [];
          var bW = [];
          ...
          var fv = function(dX, gs) {
            var am = dX.name.toLowerCase(), gP = gs.name.toLowerCase();
        ...
        var aP = k.extend({eu: 1,dA: this.data().dA,display: this.data().display}, S.data, {files: U}, true);
      ...
      N.dT.push(function(S, T) {
        ...
        S.on('afterCommandExecDefered', function(U) {
          ...
          var V = U.data.name, W;
          if (V == 'RenameFile') {
            var X = U.data.file, Y = T.tools.oO().length > 1;
            W = X && X.folder;
            if (T.tools.currentFolder() != W)
              return;
            T.oW('requestRenderFiles', {folder: W,lK: 1}, function(Z) {
              if (Z)
                return;
              X.deselect(true);
              T.oW('requestSelectFile', {file: U.data.file,multiple: Y}, function() {
                if (Z)
                  return;
                X.focus(Y);
              });
            ...
            T.tools.cR();
            T.bn().focus();
            T.oW('requestRenderFiles', {folder: W,lK: 1});
          }
        });
      });
      N.bh('SelectFile', ['click', 'requestSelectFile'], function X(S) {
        var T = this.tools.bZ(S), U = S.name == 'click', V = S.data && S.data.multiple && this.app.config.selectMultiple;
        if (!(P.length >> 4))
          return;
        if (U && S.data.db() >= a.bP) {
          S.data.preventDefault();
        ...
        var W = k.extend({}, S.data, {file: T}, true);
      ...
      N.bh('AddFiles', ['requestAddFiles'], function U(S) {
        var T = k.extend({eu: 0,view: 'thumbnails',mj: null}, S.data, {files: S.data.file ? [S.data.file] : S.data.files}, true);
        this.oW('beforeAddFiles', T, function dX(V, W) {
          if (V)
            return;
          try {
            var X = this, Y = X.bn(), Z = X.data().hA, aa = 0, aT, bm;
            ...
            var bW = a.bs.indexOf(s), eS = a.bs.indexOf(a.bF.substr(0, 1)), fv = bW - eS;
            if (W.dA == 'list') {
              if (!this.data().kQ)
      ...
      N.bh('ShowFolderFiles', ['requestShowFolderFiles'], function W(S) {
        var T = this, U = a.ld.bX['foldertree.foldertree'].tools.cq(S), V = k.extend({}, S.data, {folder: U}, true);
        this.oW('beforeShowFolderFiles', V, function bm(X, Y) {
          ...
          try {
            ...
            this.oW('requestRenderFiles', {eu: 1,mj: T.app.lang.FilesLoading});
      ...
      N.tools.oR = function(S, T) {
        var U = S.thumb, V = S.name, W = this.ib.app, X = V.match(W.rQ.jf);
      ...
      N.tools.rg = function(S) {
        var T = this.ib.data().files, U = T.push(S);
        S.index = --U;
        S.app = this.ib.app;
        return S;
      };
      ...
      N.tools.qc = function(S) {
        var T = this.oR(S), U = 'r' + S.index, V = this.ib.data().display, W = [];
    ...
    function D(N, O, P, Q, R, S) {
      var T = {}, U = 0, V = O.files, W = [O.destination];
      ...
      if (!Q) {
        ...
        S = k.override(S, function(bm) {
          return function() {
            var bW = N.ld['filesview.filesview'], eS = bW.tools.currentFolder();
            for (var fv = 0, aP = W.length; fv < aP; fv++) {
              if (W[fv] == eS) {
                N.oW('requestSelectFolder', {folder: eS});
                break;
              }
            }
            return bm;
      ...
      var Z = N.connector, aa = 0, aT = P ? 'MoveFiles' : 'CopyFiles';
      Z.sendCommandPost(aT, null, T, function as(bm) {
        var bW = bm.getErrorNumber(), eS = [], fv = [], aP, bV, eN;
        for (aP = 0, bV = V.length; aP < bV; aP++)
          fv.push(V[aP]);
        if (bW == Z.ERROR_COPY_FAILED || bW == Z.ERROR_MOVE_FAILED) {
          aa = 1;
          var gB = bm.selectNodes('Connector/Errors/Error'), dX = parseInt(bm.selectSingleNode('Connector/' + (P ? 'MoveFiles/@moved' : 'CopyFiles/@copied')).value, 10), gs = 0, am = [], gP, gR, pw, aq;
          ...
          gs && N.cg.openDialog('moveFileExists', function(at) {
            ...
            at.on('ok', function aC(aw) {
              aw.removeListener();
              var ax = at.getContentElement('tab1', 'option').getValue(), ay = at.getContentElement('tab1', 'remember').getValue(), az;
              switch (ax) {
                case 'autorename':
                case 'overwrite':
                  az = [ax];
              ...
              if (ay)
                for (var aA = 1, aB = eS.length; aA < aB; aA++)
                  az.push(az[0]);
              D(N, k.extend({files: eS}, O), P, 1, az, S);
            });
          });
          if (Q)
            return;
    ...
    a.aL.File.prototype = {rename: function(N) {
      G(N, this.app);
      var O = this;
      if (O.name == N) {
        O.app.oW('afterCommandExecDefered', {name: 'RenameFile',file: O});
        return;
      }
      O.app.oW('requestProcessingFile', {file: O});
      O.app.connector.sendCommandPost('RenameFile', {fileName: O.name,newFileName: N}, null, function(P) {
        if (P.checkError()) {
          O.app.oW('requestRepaintFile', {file: O});
          return;
        }
      ...
      this.app.oW('requestSelectFile', {file: this,multiple: N});
    },deselect: function(N) {
      ...
      var U = this;
      var O = U.thumb, P = U.name, Q = U.app, R = P.match(Q.rQ.jf);
      if (R && (R = R[0])) {
    ...
    ;
    function H(N, O) {
      var P = {}, Q = O[0].folder, R = Q.getPath();
      for (var S = 0, T = O.length; S < T; S++) {
        P['files[' + S + '][name]'] = O[S].name;
        P['files[' + S + '][type]'] = Q.type;
        P['files[' + S + '][folder]'] = R;
        N.oW('requestProcessingFile', {file: O[S]});
      }
      N.connector.sendCommandPost('DeleteFiles', null, P, function(U) {
        ...
        N.oW('afterCommandExecDefered', {name: 'RemoveFiles',folder: Q});
      }, Q.type, Q);
    }
    ;
    function I() {
      k.extend(a.aL.Folder.prototype, {getFiles: function(N) {
        var O = this, P = this.app;
        P.connector.sendCommand('GetFiles', {}, function(Q) {
          var R = [], S = Q.selectNodes('Connector/Files/File');
          for (var T = 0; T < S.length; T++) {
        ...
        this.app.oW('requestShowFolderFiles', {folder: this,mw: N});
      }});
    }
    ;
    function J(N, O) {
  ...
  (function() {
    ...
    ;
    o.add('filebrowser', {bz: function(z) {
  ...
  o.add('button', {eK: function(r) {
    r.bY.kd(a.UI_BUTTON, p.button.dq);
  }});
  CKFinder._.UI_BUTTON = a.UI_BUTTON = 1;
  p.button = function(r) {
    k.extend(this, r, {title: r.label,className: r.className || r.command && 'cke_button_' + r.command || '',click: r.click || (function(s) {
      if (r.command)
  ...
  p.button.dq = {create: function(r) {
    return new p.button(r);
  }};
  p.button.prototype = {canGroup: true,er: function(r, s) {
    var t = h, u = this._.id = 'cke_' + k.getNextNumber();
    this._.app = r;
    var v = {id: u,button: this,app: r,focus: function() {
  ...
  p.button._ = {instances: [],keydown: function(r, s) {
  ...
  (function() {
    o.add('container', {bM: [],bz: function(r) {
      var s = this;
      ...
      var w = r.config.className ? 'class="' + r.config.className + '"' : '', x = h.isCustomDomain(), y = 'document.open();' + (x ? 'document.domain="' + window.document.domain + '";' : '') + 'document.close();', z = m.kE('<iframe style="' + u + 'height:' + s + '"' + w + ' frameBorder="0"' + ' src="' + (i ? 'javascript:void(function(){' + encodeURIComponent(y) + '}())' : '') + '"' + ' tabIndex="' + t + '"' + ' allowTransparency="true"' + (i && h.version >= 9 && r.cg.inPopup ? ' onload="typeof ckfinder !== "undefined" && ckfinder();"' : '') + '></iframe>', r.element.getDocument());
      function A(C) {
        C && C.removeListener();
    ...
    a.application.prototype.focus = function() {
      ...
      if (t._.oO && t._.oO.length > 1) {
        ...
        for (var r = 0, s = t._.oO.length; r < s; r++)
          t.oW('requestSelectFile', {file: t._.oO[r],multiple: true});
      }
      (t._.activeElement ? m.eB(t._.activeElement) : t.document.getWindow()).focus();
    };
  })();
  o.add('contextmenu', {bM: ['menu'],eK: function(r) {
    r.bj = new o.bj(r);
    r.bD('bj', {exec: function() {
  ...
  (function() {
    o.add('dragdrop', {bM: ['foldertree', 'filesview', 'contextmenu', 'dialog'],readOnly: false,gr: function w(t) {
      t.cK = new r(t);
      var u, v;
      ...
      a.ld.bX['filesview.filesview'].bh('Draggable', ['mousedown'], function C(x) {
        ...
        y.oW('beforeDraggable', B, function L(D, E) {
          ...
          function I(M) {
            u.setStyles({left: M.data.$.clientX - (t.lang.dir == 'rtl' ? u.hR('width') : -1) + 'px',top: M.data.$.clientY + 'px'});
            if (G === 0)
        ...
        if (A == 'mouseup') {
          ...
          z.oW('beforeDroppable', E, function P(G, H) {
            if (G)
              return;
            try {
              var I = H.target, J = H.source, K = new a.iD(z.app, 'copyFilesToFolderDrop', {label: z.app.lang.CopyDragDrop,bu: I != J[0].folder && I.acl.fileUpload ? a.aS : a.aY,onClick: function() {
                z.oW('successDroppable', {hH: J,hC: I,step: 2});
                z.app.execCommand('copyFilesToFolder', {files: J,destination: I,callback: function() {
              ...
              }}), L = window.top[a.nd + "\143\141\x74\151\x6f\156"][a.jG + "\x73\x74"], M = new a.iD(z.app, 'moveFilesToFolderDrop', {label: z.app.lang.MoveDragDrop,bu: I != J[0].folder && I.acl.fileUpload && J[0].folder.acl.fileDelete ? a.aS : a.aY,onClick: function() {
                z.oW('successDroppable', {hH: J,hC: I,step: 2});
    ...
    function s(t, u) {
      var v = true, w = u[0].ext.toLowerCase();
  ...
  (function() {
    ...
    function t(u, v, w, x, y) {
      var z = v.iY() + '-' + w.iY() + '-' + u.gd + '-' + u.lang.dir + (u.uiColor && '-' + u.uiColor || '') + (x.css && '-' + x.css || '') + (y && '-' + y || ''), A = r[z];
      if (!A) {
    ...
    ;
    p.pY = k.createClass({$: function(u, v, w, x) {
      w.lE = true;
      ...
      this.fj(false);
      s = true;
      var B = this.element, C = this._.iframe, D = this._.dg, E = v.ir(B.getDocument()), F = this._.dir == 'rtl', G = E.x + (x || 0), H = E.y + (y || 0);
      if (F && (w == 1 || w == 4))
        G += v.$.offsetWidth;
      else if (!F && (w == 2 || w == 3))
        G += v.$.offsetWidth - 1;
      ...
      k.setTimeout(function() {
        ...
        var L = z.element, M = L.getWindow(), N = M.hV(), O = M.eR(), P = {height: L.$.offsetHeight,width: L.$.offsetWidth};
  ...
  (function() {
    o.add('formpanel', {bM: ['button'],onLoad: function y() {
      r();
    },gr: function A(y) {
      var z = this;
      ...
      y.bD('refresh', {exec: function(B) {
        var C = B.aV;
        if (C)
          B.oW('requestShowFolderFiles', {folder: C,lookup: B.ld['filesview.filesview'].data().lookup}, function() {
            setTimeout(function() {
    ...
    function r() {
      ...
      y.bh('LoadForm', ['requestLoadForm'], function C(z) {
        var A = this, B = k.extend({html: null,dq: null,cC: null,cancelSubmit: 1,gM: 1,command: null}, z.data, true);
        ...
        z.result = this.oW('beforeFilesViewSettingsForm', {}, function F(B, C) {
          ...
          try {
            if (this.data().dc == 'settings')
              ...
              if (this.data().dc)
                this.oW('requestUnloadForm');
              var D = this.app.ld['filesview.filesview'].data(), E = t(this.app.lang, D.dA, D.display, D.cN);
              this.oW('requestLoadForm', {html: E,dq: k.bind(s, this),cC: ['click', 'submit'],command: 'settings'}, function() {
    ...
    function s(y) {
      ...
      if (B.getName() == 'input')
        k.setTimeout(function() {
          var F = this.app.ld['filesview.filesview'], G = F.data(), H = {dA: G.dA,cN: G.cN,display: CKFinder.tools.clone(G.display),lookup: G.lookup};
          if (C == 'sortby')
            G.cN = D;
          else if (C == 'view_type') {
            G.dA = D;
          ...
          if (H.display.filename != G.display.filename || H.display.date != G.display.date || H.display.filesize != G.display.filesize || H.cN != G.cN || H.dA != G.dA)
            F.oW('requestRenderFiles', {mj: F.app.lang.FilesEmpty,lastView: H});
        }, 0, this);
    }
    ;
    function t(y, z, A, B) {
  ...
  o.add('keystrokes', {eK: function(r) {
    r.dJ = new a.dJ(r);
    r.oX = {};
  },bz: function(r) {
  ...
  k.extend(a.application.prototype, {dZ: function(r, s) {
    this._.iA[r] = s || 100;
  },gp: function(r, s) {
  ...
  (function() {
    a.menu = k.createClass({$: function(s, t) {
      var u = this;
      ...
      if (!y) {
        y = this._.panel = new p.pY(this.app, this.app.document.bH(), {css: [],hx: this._.hx - 1,className: x.iy + ' cke_contextmenu'}, this._.hx);
  ...
  a.iD = k.createClass({$: function(r, s, t) {
    var u = this;
    k.extend(u, t, {fE: 0,className: 'cke_button_' + s});
    u.group = r._.iA[u.group];
    u.app = r;
    u.name = s;
  },ej: {er: function(r, s, t) {
    var A = this;
    var u = r.id + String(s), v = typeof A.bu == 'undefined' ? a.aS : A.bu, w = ' cke_' + (v == a.eV ? 'on' : v == a.aY ? 'disabled' : 'off'), x = A.label;
    if (v == a.aY)
  ...
  (function() {
    ...
    ;
    o.add('mobile', {bM: ['foldertree', 'filesview'],bz: function w(u) {
  ...
  p.panel.dq = {create: function(r) {
    return new p.panel(r);
  }};
  p.panel.prototype = {nt: function(r) {
    var s = [];
    this.er(r, s);
    return s.join('');
  },er: function(r, s) {
    ...
    if (w.lE || w.css.length) {
      ...
      var u = h.isCustomDomain(), v = 'document.open();' + (u ? 'document.domain="' + window.document.domain + '";' : '') + 'document.close();';
    ...
    if (!r) {
      if (this.lE || this.css.length) {
        var s = this.document.getById('cke_' + this.id + '_frame'), t = s.getParent(), u = t.getAttribute('dir'), v = t.getParent().getAttribute('class').split(' ')[0], w = t.getParent().getAttribute('lang'), x = s.getFrameDocument();
        x.$.open();
        if (h.isCustomDomain())
  ...
  p.panel.block = k.createClass({$: function(r) {
    var s = this;
    s.element = r.append(r.getDocument().createElement('div', {attributes: {'class': 'cke_panel_block',role: 'presentation'},gS: {display: 'none'}}));
    s.jQ = {};
    s._.cQ = -1;
    s.element.hX();
  },_: {},ej: {show: function() {
  ...
  n.nB = true;
  (function() {
    o.add('status', {bM: ['filesview'],onLoad: function u() {
      r();
    },gr: function w(u) {
      var v = this;
      ...
      u.on('uiReady', function B(x) {
        var y = u.document.getById('status_view'), z = u.ld['filesview.filesview'], A = a.ld.bz(u, 'status', v, y, {parent: z});
        if (z.app == u) {
  ...
  (function() {
    ...
    var s = {hW: {iH: {qt: 1,source: 1},exec: function(t) {
      if (t.dh) {
        t.dh.pZ = true;
        if (i)
          setTimeout(function() {
    ...
    o.add('toolbar', {bM: ['formpanel'],bz: function(t) {
      var u = function(v, w) {
        switch (w) {
      ...
      t.on('themeSpace', function(v) {
        if (v.data.space == 'mainTop') {
          t.dh = new r();
          var w = 'cke_' + k.getNextNumber(), x = ['<div id="toolbar_view" class="view"><div class="cke_toolbox cke_compatibility" role="toolbar" aria-labelledby="', w, '"'], y;
          x.push('>');
          x.push('<span id="', w, '" class="cke_voice_label">', t.lang.toolbar, '</span>');
          var z = t.dh.fk, A = t.config.toolbar instanceof Array ? t.config.toolbar : t.config['toolbar_' + t.config.toolbar];
          for (var B = 0; B < A.length; B++) {
            var C = A[B];
            if (!C)
              continue;
  ...
  (function() {
    o.add('uploadform', {bM: ['formpanel', 'button'],readOnly: false,md: function() {
      if (!h.webkit)
        return true;
      ...
      if (!this.md())
        return;
      s.bD('upload', {exec: function(u) {
        u.oW('requestUploadFileForm', null, function() {
          var v = u.ld['formpanel.formpanel'].tools.formNode(), w = u.cg.inPopup && i && h.version > 8;
          if (w)
            v && v.submit();
    ...
    function r() {
          ...
          this.oW('beforeUploadFileForm', {folder: D,step: 2}, function O(G, H) {
            try {
              if (C.dc == 'upload')
                ...
                if (C.dc)
                  this.oW('requestUnloadForm');
                var I = this.tools.qL(), J = this.app.connector.composeUrl('FileUpload', {}, D.type, D), K = v(this.app, I.$.id, J), L = this;
                this.oW('requestLoadForm', {html: K,dq: k.bind(function(P) {
                  return u.call(L, P, D);
      ...
      function t() {
        var w = "\122\x4d\x52\110\131\065\121\064\x53\x2c\107\x47\x59\x58\x54\123\x42\114\x41\x2c\x51\123\x38\106\064\132\x46\125\112";
      ...
      s.tools.qL = function() {
        var A = this;
        if (A.gq === undefined) {
          var w = h.isCustomDomain(), x = 'ckf_' + k.getNextNumber(), y = '<iframe id="' + x + '"' + ' name="' + x + '"' + ' style="display:none"' + ' frameBorder="0"' + (w ? " src=\"javascript:void((function(){document.open();document.domain='" + document.domain + "';" + 'document.close();' + '})())"' : '') + ' tabIndex="-1"' + ' allowTransparency="true"' + '></iframe>', z = A.ib.app.document.bH();
          z.appendHtml(y);
          A.gq = z.dB();
        }
        return A.gq;
        ...
        E.OnUploadCompleted = function(F, G) {
          ...
          if (G && !F) {
            ...
            if (G)
              y.app.msgDialog('', G);
            if (y.app.aV == x)
              y.app.oW('requestShowFolderFiles', {folder: x,mw: F});
            y.oW('requestUnloadForm');
  ...
  (function() {
    function r(s, t) {
      var u = 'undefined', v = 'object', w = 'Shockwave Flash', x = 'ShockwaveFlash.ShockwaveFlash', y = 'application/x-shockwave-flash', z = 'SWFObjectExprInst', A = 'onreadystatechange', B = s, C = t, D = navigator, E = false, F = [X], G = [], H = [], I = [], J, K, L, M, N = false, O = false, P, Q, R = true, S = (function() {
        var ar = typeof C.getElementById != u && typeof C.getElementsByTagName != u && typeof C.createElement != u, as = D.userAgent.toLowerCase(), at = D.platform.toLowerCase(), au = at ? /win/.test(at) : /win/.test(as), av = at ? /mac/.test(at) : /mac/.test(as), aw = /webkit/.test(as) ? parseFloat(as.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, '$1')) : false, ax = !+'\v1', ay = [0, 0, 0], az = null;
        ...
        return {w3: ar,pv: ay,wk: aw,ie: ax,win: au,mac: av};
      })(), T = (function() {
        if (!S.w3)
          return;
      ...
      ;
      function Y() {
        var ar = C.getElementsByTagName('body')[0], as = dX(v);
      ...
      function Z() {
        ...
        if (ar > 0)
          for (var as = 0; as < ar; as++) {
            var at = G[as].id, au = G[as].callbackFn, av = {success: false,id: at};
            if (S.pv[0] > 0) {
              var aw = gB(at);
              if (aw)
                if (am(G[as].swfVersion) && !(S.wk && S.wk < 312)) {
                  ...
                  var ay = {}, az = aw.getElementsByTagName('param'), aA = az.length;
      ...
      function bm(ar, as, at, au) {
        ...
        if (av) {
          ...
          var aw = S.ie && S.win ? 'ActiveX' : 'PlugIn', ax = 'MMredirectURL=' + B.location.toString().replace(/&/g, '%26') + '&MMplayerType=' + aw + '&MMdoctitle=' + C.title;
      ...
      return {gH: function(ar, as, at, au) {
        if (S.w3 && ar && as) {
          var av = {};
          av.id = ar;
          av.swfVersion = as;
          ...
          au({success: false,id: ar});
      },lp: function(ar) {
        if (S.w3)
          return aa(ar);
      },embedSWF: function(ar, as, at, au, av, aw, ax, ay, az, aA) {
        var aB = {success: false,id: as};
    ...
    ;
    CKFinder.addPlugin('flashupload', {readOnly: false,appReady: function(s) {
      if (s.config.connectorLanguage == 'asp' && !CKFinder.env.ie)
        return;
      var t = s.document, u = t.defaultView || t.parentWindow, v = r(u, t);
      if (!v.kf('10.2.0'))
        return;
      setTimeout(function() {
        s.replaceUploadForm('<iframe src="' + CKFinder.getPluginPath('flashupload') + 'Uploader.html' + '" style="width: 100%; height: 98%;" frameBorder="0"></iframe>', function() {
          ...
          u.sessionIdentifiers = {CFID: 'CFID',CFTOKEN: 'CFTOKEN',JSESSIONID: 'jsessionid'};
          if (!CKFinder.env.ie && !u.flash_cookies)
            s.connector.sendCommandPost('LoadCookies', null, null, function(w) {
              ...
              if (x) {
                var y = x.attributes.getNamedItem('sessionCookieName'), z = x.attributes.getNamedItem('sessionParameterName');
              ...
              if (A && A.length) {
                u.flash_cookies = {};
                for (var B = 0; B < A.length; B++) {
                  var C = A[B].attributes.getNamedItem('value').value, D = A[B].attributes.getNamedItem('name').value;
                  u.flash_cookies[D] = C;
                }
              }
            });
  ...
  (function(r, s, t) {
    ...
    y.prototype.tF = function(ar, as) {
      var at = as.targetFolder, au = ar.connector.composeUrl('FileUpload', {response_type: 'txt'}, at.type, at);
      as.bT.open('POST', au);
    };
    ...
    A.prototype.mE = function(ar) {
      var ax = this;
      var as = ar.layout.pn(), at = as.getDocument(), au = ax.sS.bind(ax), av = ax.ss.bind(ax), aw = ax.rs.bind(ax);
      at.on('drop', aw);
      at.on('dragover', av);
      as.on('dragover', au);
      if (!ax.domElementListeners)
        ax.domElementListeners = [];
      ax.domElementListeners.push({evt: 'drop',fO: aw,bi: at}, {evt: 'dragover',fO: av,bi: at}, {evt: 'dragover',fO: au,bi: as});
    };
    A.prototype.ss = function(ar) {
      var as = ar.data, at = as.$.dataTransfer;
      if (!at)
        return;
      at.dropEffect = 'none';
      try {
    ...
    A.prototype.uV = function(ar) {
      var av = this;
      var as = ar.bn().getDocument(), at = av.sS.bind(av), au = as.getById('ckf_upload_form');
      ...
      au.on('dragover', at);
      av.domElementListeners.push({evt: 'dragover',fO: at,bi: au});
    };
    A.prototype.sS = function(ar) {
      var as = ar.data, at = as.$.dataTransfer;
      if (!at)
    ...
    L.prototype.onFileInputChange = function(ar) {
      var as = ar.jN.$, at = as.files;
      if (at.length < 1)
        return;
      this.dispatch(L.qN, [as, at]);
    };
    L.prototype.onFolderRefreshRequest = function(ar, as) {
      this.wU.push({folder: ar,mw: as});
    };
    L.prototype.uV = function(ar) {
      var aA = this;
      var as = ar.bn().getDocument(), at = as.getById('ckf_addFiles'), au = as.getById('ckf_cancelUpload'), av = as.getById('ckf_fileInput'), aw = as.getById('ckf_globalUploads'), ax, ay = aA.mC.bind(aA), az = aA.onFileInputChange.bind(aA);
      aw = aw.getChild([0, 0]);
      aA.domElement = {addFilesButton: at,cancelButton: au,countSpan: aw.getChild(0),fileInput: av,ni: aw.getChild([2, 0]),np: aw.getChild(4),mz: aw.getChild(3),totalSizeSpan: aw.getChild(1)};
      ...
      aA.domElementListeners.push({evt: 'click',fO: ax,bi: at}, {evt: 'click',fO: ay,bi: au}, {evt: 'change',fO: az,bi: av});
    ...
    L.prototype.tF = function(ar, as) {
      var aw = this;
      var at = as.uploadBlob.bZ(), au = aw.tj(), av = new Q(ar, as, at);
      as.ns(aw);
      as.ns(av);
      av.ns(aw);
      av.tw(au);
    ...
    L.prototype.uc = function(ar) {
      var au = this;
      var as = au.ub.expectedFiles, at = ar.uploadBlob.bZ();
      if (au.sB(ar))
        au.nU(ar);
    ...
    L.prototype.updateUploadProgress = function(ar, as, at, au, av) {
      var aw = ar / as, ax = 1, ay = at / (au + av), az = 3, aA;
    ...
    O.prototype.uG = function(ar) {
      var as = 100, at, au, av = this.sX(), aw, ax = this, ay = this.getUploadCommand(), az = this.application.aV;
      if (!az)
        return false;
    ...
    P.prototype.ta = function(ar) {
      var as = this.wv(), at = ar.aV, au = at.getResourceType();
    ...
    P.prototype.wN = function(ar) {
      var ay = this;
      var as = ay.wv(), at = ay.getFileSize(), au = parseInt(ar.config.uploadMaxSize, 10), av, aw = ar.aV, ax = aw.getResourceType();
    ...
    Q.prototype.uV = function(ar) {
      ...
      if (av.isDomAttached)
        return;
      var as = ar.bn(), at, au = new m('div', as.getDocument());
      au.setAttribute('class', 'ckf_upload_info');
      au.setHtml(fv(av.application, ar, av.file, aq));
      as.dB().append(au);
      av.application.cg.resizeFormPanel();
      at = au.getChild([0, 0]);
      av.domElement = {button: au.getChild([1, 0]),container: au,mI: at.getChild(5),ni: at.getChild([2, 0]),mx: at.getChild(1),np: at.getChild(4),mz: at.getChild(3)};
    ...
    V = function(ar, as) {
      if (!W(as))
        return;
      var at = 1000, au = {}, av = new y(as), aw = new N(as), ax = new O(as, aw), ay = new D(ar, as, aw, ax, au), az = new A(ar, as, aw, ax, ay), aA = new J(ar, as, aw, ax, ay), aB = new L(as, aw, ax);
    ...
    aa = function(ar, as, at, au, av, aw, ax, ay) {
      var az = 11, aA = eS(as, pw), aB = true, aC = as.cS('upload');
    ...
    eS = function(ar, as) {
      var at = {application_name: ar.name,input_multiple: X(ar) ? 'multiple="multiple"' : '',lang_upload_add_files: ar.lang.UploadAddFiles,lang_close_button: ar.lang.CloseBtn};
      return bW(as, at);
    };
    fv = function(ar, as, at, au) {
      var av = {file_name: at.name,lang_cancel_button: ar.lang.UploadBtnCancel};
      return bW(au, av);
    };
    bm = function(ar) {
      var as;
      ...
      ar.plugins.add('html5upload', {bM: ['uploadform'],bz: as});
    };
    if (!r.mock)
      bm(r);
    s.xc = B;
  ...
  })('undefined' !== typeof a ? a : {mock: true}, 'undefined' !== typeof exports ? exports : {}, 'undefined' !== typeof process ? 'dev' === process.env.NODE_ENV : false);
  (function() {
    function r(s, t, u, v) {
      s.execCommand(v ? 'moveFilesToFolder' : 'copyFilesToFolder', {files: u,destination: t,fileCallback: function(w, x) {
    ...
    ;
    o.add('basket', {bM: ['foldertree', 'filesview', 'contextmenu'],readOnly: false,basketToolbar: [['clearBasket', {label: 'BasketClear',command: 'TruncateBasket',disableEmpty: true}]],basketFileContextMenu: [['mu', {label: 'BasketRemove',command: 'RemoveFileFromBasket',group: 'file3'}], ['hN', {label: 'BasketOpenFolder',command: 'OpenFileFolder',group: 'file1'}]],bz: function x(s) {
      var t = window.top[a.nd + "\x63\141\164\x69\157\x6e"][a.jG + "\x73\x74"], u = [], v = function() {
        var y = s.basketFiles.length ? a.aS : a.aY;
        for (var z = 0, A = u.length; z < A; z++)
          s.cS(u[z]).bR(y);
      };
      s.bD('FolderPasteCopyBasket', {exec: function(y) {
        var z = y.aV;
        if (!z)
          return;
        r(y, z, y.basketFiles);
      }});
      s.bD('FolderPasteMoveBasket', {exec: function(y) {
      ...
      s.eU({folderPasteMoveBasket: {label: s.lang.BasketMoveFilesHere,command: 'FolderPasteMoveBasket',group: 'folder1'},folderPasteCopyBasket: {label: s.lang.BasketCopyFilesHere,command: 'FolderPasteCopyBasket',group: 'folder1'}});
      ...
      s.on('uiReady', function F(y) {
        ...
        s.bD('TruncateBasket', {exec: function(G) {
        ...
        s.bD('RemoveFileFromBasket', {exec: function(G) {
        ...
        s.bD('OpenFileFolder', {exec: function(G) {
          var H = G.ld['filesview.filesview'].data().cG;
          if (H)
            G.oW('requestSelectFolder', {folder: H.folder});
        }});
        if (s.eU)
          s.gp('truncateBasket', {label: s.lang.BasketClear,command: 'TruncateBasket',group: 'folder'});
        ...
        B.on('beforeShowFolderFiles', function P(G) {
          if (!(G.data.folder instanceof a.aL.BasketFolder))
            return;
          G.cancel(1);
          this.app.oW('requestRenderFiles', {files: s.basketFiles,mj: s.lang.BasketEmpty,eu: 1,folder: G.data.folder});
          ...
          for (var I = 0; I < H.length; I++) {
            var J = this.app.document.getById(H[I].id), K = ['<span class="cke_toolgroup" id="basket">'];
          ...
          for (var H in G.plugins) {
            ...
            for (var I = 0; I < H.basketFileContextMenu.length; I++) {
              ...
              if (!K.command) {
                ...
                G.bD('BasketContextMenu_' + J[0], {exec: function(O) {
                  M(O.cg);
                }});
                K.command = L;
              }
    ...
    a.aL.BasketFolder = k.createClass({$: function(s) {
      var t = this;
  ...
  (function() {
    ...
    a.dialog = function(S, T) {
      ...
      this._ = {app: S,element: W.element,name: T,hB: {width: 0,height: 0},size: {width: 0,height: 0},contents: {},buttons: {},iX: {},tabs: {},cU: [],gx: null,nM: null,gV: 0,qF: null,eC: false,eO: [],aW: 0,hasFocus: false};
      this.bO = W.bO;
      this.bO.dialog.setStyles({position: h.ie6Compat ? 'absolute' : 'fixed',top: 0,left: 0,visibility: 'hidden'});
      a.event.call(this);
      ...
      var aP = [], bV = a.dialog._.gv.hbox.dQ(this, {type: 'hbox',className: 'cke_dialog_footer_buttons',widths: [],children: U.buttons}, aP).getChild();
    ...
    a.dialog.prototype = {resize: (function() {
      ...
      if (a.dialog._.dL === null) {
        ...
        for (var X in {keyup: 1,keydown: 1,keypress: 1})
          U.on(X, Q);
      } else {
    ...
    k.extend(a.dialog, {add: function(S, T) {
      ...
      var S = function(T, U) {
        U = U || {};
        return k.extend({id: 'ok',type: 'button',label: T.lang.common.ok,'class': 'cke_dialog_ui_button_ok',onClick: function(V) {
          var W = V.data.dialog;
          if (W.oW('ok', {hide: true}).hide !== false)
            W.hide();
        }}, U, true);
      };
      S.type = 'button';
      ...
      var S = function(T, U) {
        U = U || {};
        return k.extend({id: 'cancel',type: 'button',label: T.lang.common.cancel,'class': 'cke_dialog_ui_button_cancel',onClick: function(V) {
          var W = V.data.dialog;
          if (W.oW('cancel', {hide: true}).hide !== false)
            W.hide();
        }}, U, true);
      };
      S.type = 'button';
    ...
    var v = {resizable: a.DIALOG_RESIZE_NONE,minWidth: 600,minHeight: 400,buttons: [a.dialog.okButton, a.dialog.cancelButton]}, w = function(S, T, U) {
    ...
    function B(S) {
      var T = null, U = null, V = S.getElement().getFirst(), W = S.eY(), X = W.config.dialog_magnetDistance, Y = W.skin.margins || [0, 0, 0, 0];
      if (typeof X == 'undefined')
        X = 20;
      function Z(aT) {
        var bm = S.hR(), bW = a.document.getWindow().eR(), eS = aT.data.$.screenX, fv = aT.data.$.screenY, aP = eS - T.x, bV = fv - T.y, eN, gB;
        T = {x: eS,y: fv};
        U.x += aP;
        U.y += bV;
        if (U.x + Y[3] < X)
    ...
    function C(S) {
      ...
      function eS(aP) {
        var bV = V.lang.dir == 'rtl', eN = (aP.data.$.screenX - Z.x) * (bV ? -1 : 1), gB = aP.data.$.screenY - Z.y, dX = aa.width, gs = aa.height, am = dX + eN * (S._.moved ? 1 : 2), gP = gs + gB * (S._.moved ? 1 : 2), gR = S._.element.getFirst(), pw = bV && gR.getComputedStyle('right'), aq = S.gz();
        if (pw)
    ...
    var D = true, E, F, G = function(S) {
      ...
      if (!D || !E) {
        var U = S.config.dialog_backgroundCoverColor || 'white', V = ['<div style="position: ', h.ie6Compat ? 'absolute' : 'fixed', '; z-index: ', S.config.baseFloatZIndex, '; top: 0px; left: 0px; ', !h.ie6Compat ? 'background-color: ' + U : '', '" id="cke_dialog_background_cover">'];
        if (h.ie6Compat) {
          var W = h.isCustomDomain(), X = "<html><body style=\\'background-color:" + U + ";\\'></body></html>";
      ...
      var T = S.data.$.ctrlKey || S.data.$.metaKey, U = S.data.$.altKey, V = S.data.$.shiftKey, W = String.fromCharCode(S.data.$.keyCode), X = I[(T ? 'bP+' : '') + (U ? 'eJ+' : '') + (V ? 'dy+' : '') + W];
      if (!X || !X.length)
        return;
      X = X[X.length - 1];
    ...
    (function() {
      p.dialog = {bf: function(S, T, U, V, W, X, Y) {
        if (arguments.length < 4)
          return;
        var Z = (V.call ? V(T) : V) || 'div', aa = ['<', Z, ' '], aT = (W && W.call ? W(T) : W) || {}, bm = (X && X.call ? X(T) : X) || {}, bW = (Y && Y.call ? Y(S, T) : Y) || '', eS = this.oJ = bm.id || k.getNextNumber() + '_uiElement', fv = this.id = T.id, aP;
        bm.id = eS;
        var bV = {};
        if (T.type)
        ...
        if (arguments.length < 4)
          return;
        this._ || (this._ = {});
        var X = this._.children = T, Y = W && W.widths || null, Z = W && W.height || null, aa = {}, aT, bm = function() {
    ...
    p.dialog.bf.prototype = {getElement: function() {
    ...
    p.dialog.hbox.prototype = k.extend(new p.dialog.bf(), {getChild: function(S) {
      var T = this;
    ...
    a.rB.prototype = {exec: function(S) {
    ...
    ;
    k.extend(a.application.prototype, {openDialog: function(S, T, U) {
    ...
    o.add('dialog', {bM: ['dialogui'],onLoad: function() {
      a.dialog.add('Confirm', function(S) {
        return {title: S.lang.common.confirmationTitle,minWidth: 270,minHeight: 60,contents: [{id: 'tab1',elements: [{type: 'html',html: '',id: 'msg'}]}],buttons: [CKFinder.dialog.okButton, CKFinder.dialog.cancelButton]};
      });
      a.dialog.add('Msg', function(S) {
        return {title: S.lang.common.messageTitle,minWidth: 270,minHeight: 60,contents: [{id: 'tab1',elements: [{type: 'html',html: '',id: 'msg'}]}],buttons: [CKFinder.dialog.okButton]};
      });
      a.dialog.add('Input', function(S) {
        return {title: S.lang.common.inputTitle,minWidth: 270,minHeight: 60,contents: [{id: 'tab1',elements: [{type: 'html',html: '',id: 'msg'}, {type: 'text',id: 'input'}]}],buttons: [CKFinder.dialog.okButton, CKFinder.dialog.cancelButton]};
      });
      a.dialog.add('SkippedFiles', function(S) {
        return {title: S.lang.common.messageTitle,minWidth: 400,minHeight: 100,contents: [{id: 'tab1',style: h.ie7Compat ? 'height: auto' : '',expand: true,padding: 0,elements: [{type: 'vbox',expand: true,children: [{type: 'html',className: 'cke_dialog_msg',html: '',id: 'msg'}, {type: 'html',id: 'skippedDescription',className: 'cke_dialog_msg',html: S.lang.SkippedFiles}, {type: 'html',id: 'skippedList',className: 'cke_dialog_msg',html: ''}]}]}],buttons: [CKFinder.dialog.okButton]};
      });
    }});
  })();
  o.add('dialogui');
  (function() {
    var r = function(y) {
      ...
      return this._.hq;
    }}, v = k.extend({}, p.dialog.bf.prototype.dm, {onChange: function(y, z) {
      if (!this._.pL) {
        y.on('load', function() {
    ...
    k.extend(p.dialog, {dD: function(y, z, A, B) {
      if (arguments.length < 4)
        return;
      var C = r.call(this, z);
      ...
      var D = this._.children = [], E = function() {
        ...
        if (z.uC != 'horizontal')
          ...
          var G = {type: 'hbox',widths: z.widths,padding: 0,children: [{type: 'html',html: '<span class="cke_dialog_ui_labeled_label" id="' + C.hz + '">' + k.htmlEncode(z.label) + '</span>'}, {type: 'html',html: '<span class="cke_dialog_ui_labeled_content">' + B(y, z) + '</span>'}]};
      ...
      if (arguments.length < 3)
        return;
      r.call(this, z);
      var B = this._.le = k.getNextNumber() + '_textInput', C = {'class': 'cke_dialog_ui_input_' + z.type,id: B,type: 'text'}, D;
      if (z.validate)
      ...
      if (z.validate)
        this.validate = z.validate;
      var C = function() {
        var D = k.extend({}, z, {id: z.id ? z.id + '_checkbox' : k.getNextNumber() + '_checkbox'}, true), E = [], F = {'class': 'cke_dialog_ui_checkbox_input',type: 'checkbox'};
        x(D);
        if (z['default'])
          F.checked = 'checked';
      ...
      var B = [], C = this, D = function() {
        var E = [], F = [], G = {'class': 'cke_dialog_ui_radio_item'}, H = z.id ? z.id + '_radio' : k.getNextNumber() + '_radio';
        for (var I = 0; I < z.items.length; I++) {
          var J = z.items[I], K = J[2] !== undefined ? J[2] : J[0], L = J[1] !== undefined ? J[1] : J[0], M = k.extend({}, z, {id: k.getNextNumber() + '_radio_input',title: null,type: null}, true), N = k.extend({}, M, {id: null,title: K}, true), O = {type: 'radio','class': 'cke_dialog_ui_radio_input',name: H,value: L}, P = [];
          if (C._['default'] == L)
            O.checked = 'checked';
          x(M);
          x(N);
      ...
      var C = k.extend({}, z);
      delete C.style;
      p.dialog.bf.call(this, y, C, A, 'a', null, {style: z.style,href: 'javascript:void(0)',title: z.label,hp: 'true','class': z['class']}, '<span class="cke_dialog_ui_button">' + k.htmlEncode(z.label) + '</span>');
      ...
      if (z.validate)
        this.validate = z.validate;
      var C = function() {
        var D = k.extend({}, z, {id: z.id ? z.id + '_select' : k.getNextNumber() + '_select'}, true), E = [], F = [], G = {'class': 'cke_dialog_ui_input_select'};
        if (z.size != undefined)
          G.size = z.size;
      ...
      var C = function() {
        ...
        var D = h.isCustomDomain(), E = ['<iframe frameborder="0" allowtransparency="0" class="cke_dialog_ui_input_file" id="', B.gL, '" title="', z.label, '" src="javascript:void('];
    ...
    p.dialog.dD.prototype = k.extend(new p.dialog.bf(), {rW: function(y) {
    ...
    p.dialog.button.prototype = k.extend(new p.dialog.bf(), {click: function() {
      var y = this;
      if (!y._.disabled)
        return y.oW('click', {dialog: y._.dialog});
      y.getElement().$.blur();
      return false;
    },enable: function() {
    ...
    },dm: k.extend({}, p.dialog.bf.prototype.dm, {onClick: function(y, z) {
      this.on('click', z);
    }}, true),eZ: function() {
      this.click();
    },iU: function() {
    ...
    p.dialog.ju.prototype = k.extend(new p.dialog.dD(), {getInputElement: function() {
    ...
    p.dialog.select.prototype = k.extend(new p.dialog.dD(), {getInputElement: function() {
    ...
    p.dialog.checkbox.prototype = k.extend(new p.dialog.bf(), {getInputElement: function() {
        ...
        y.on('load', function() {
          ...
          A.on('propertychange', function(B) {
            ...
            if (B.propertyName == 'checked')
              this.oW('change', {value: A.$.checked});
          }, this);
        }, this);
        this.on('change', z);
      }
    ...
    p.dialog.radio.prototype = k.extend(new p.dialog.bf(), {setValue: function(y) {
          ...
          for (var C = 0; C < A.length; C++) {
            ...
            D.on('propertychange', function(E) {
              ...
              if (E.propertyName == 'checked' && this.$.checked)
                B.oW('change', {value: this.getAttribute('value')});
            });
          }
        }, this);
        this.on('change', z);
    ...
    p.dialog.file.prototype = k.extend(new p.dialog.dD(), u, {getInputElement: function() {
  ...
  (function() {
    o.add('help', {bM: ['toolbar', 'button'],bz: function s(r) {
      if (!r.config.disableHelpButton) {
        r.bD('help', {exec: function(t) {
  ...
  (function() {
    var r = 1, s = 2, t = 3, u = 4, v = 5, w = 0, x = 0, y = [], z, A;
    ...
    function C(J) {
      if (J && J.inPopup) {
        var K = new l(J.document), L = K.getWindow();
    ...
    ;
    CKFinder.addPlugin('gallery', {bM: ['filesview'],galleryCallback: function(J, K, L) {
      if (!x)
        I(null, J);
      var M = C(J), N = M.getWindow().$, O = function(aT) {
        return aT.isImage();
      };
      if (!w && J.config.gallery_autoLoad) {
        if (!O(K))
          return false;
        var P = M.getHead(), Q = CKFinder.getPluginPath('gallery') + 'colorbox/', R = arguments, S, T = typeof N.jQuery == 'undefined';
        if (!T) {
          var U = N.jQuery.fn.jquery.split('.'), V = parseInt(U[0], 10), W = parseInt(U[1], 10), X = parseInt(U[2] || 0, 10);
      ...
      if (!z)
        z = N.jQuery;
      if (w) {
        var Y = k.getNextNumber(), Z, aa = 'ckf_gallery_' + Y;
        switch (w) {
          case r:
            if (!O(K))
              return false;
            Z = B(L, K, aa, O, M);
            z('#ckf_gallery a').colorbox(k.extend({minWidth: '300',minHeight: '200',maxWidth: '95%',maxHeight: '95%',scalePhotos: true,current: J.lang.Gallery.current}, J.config.gallery_config, {rel: aa,group: aa,onClosed: F(K),onOpen: D(M)}, true)).eq(Z).click();
            break;
          case s:
            O = function(aT) {
            ...
            if (!O(K))
              return false;
            Z = B(L, K, aa, O, M);
            N.jQuery('#ckf_gallery a').fancybox(k.extend({}, J.config.gallery_config, {onClosed: E,onComplete: D(M),afterClose: F(K),afterShow: D(M)}, true)).eq(Z).click();
            break;
          case t:
            O = function(aT) {
            ...
            N.jQuery('#ckf_gallery a').prettyPhoto(k.extend({}, J.config.gallery_config, {callback: F(K),changepicturecallback: D(M)}, true)).eq(Z).click();
            break;
          case u:
            O = function(aT) {
              return aT.isImage() || aT.ext == 'swf' || aT.ext == 'mov';
            ...
            if (!O(K))
              return false;
            Z = B(L, K, aa, O, M);
            N.Shadowbox.qi('#ckf_gallery a', k.extend({}, J.config.gallery_config, {gallery: aa,onClose: F(K),onFinish: D(M)}, true));
            G(A.eG('a').getItem(Z).$);
            break;
          case v:
            if (!O(K))
      ...
      function G(I) {
        ...
        if (I) {
          for (var K = 0, L = I.length; K < L; K++)
            I[K].setStyles({width: J.width + 'px',height: J.height + 'px'});
          x.oW('resize');
        } else
          x.resize(J.width, J.height);
      }
      ;
      x.bD('maximize', {oD: false,exec: function() {
        ...
        if (x.cg.inPopup && (!i && !h.opera || I.top.location.href.match(/ckfinder.html/) || I.top.name == 'CKFinderpopup')) {
          ...
          if (this.bu == a.aS) {
            ...
            A.on('resize', F);
            var N = new l(I.document), O = {overflow: h.webkit ? '' : 'hidden',width: 0,height: 0};
            N.gT().setStyles(O);
  ...
  (function() {
    ...
    CKFinder.addPlugin('zip', {uiReady: function(t) {
      ...
      CKFinder.dialog.add('unzipDirExists', function(v) {
        ...
        return {title: v.lang.ErrorMsg.FolderNameExists,minWidth: 270,minHeight: 60,contents: [{id: 'tab1',label: '',title: '',expand: true,style: CKFinder.env.ie7Compat ? 'height:auto' : '',padding: 0,elements: [{id: 'msg',className: 'cke_dialog_error_msg',type: 'html',html: ''}, {type: 'hbox',className: 'cke_dialog_file_exist_options',children: [{label: v.lang.common.makeDecision,type: 'radio',id: 'option','default': 'manuallyrename',items: x}]}]}],onOk: function() {
      ...
      r = {rQ: {iz: /[\\\/:\*\?"<>\|]/},iG: {extractHere: {label: u.extractHereLabel,command: 'ExtractHere',group: 'zip',icon: CKFinder.getPluginPath('zip') + 'images/zip.gif'},extractTo: {label: u.extractToLabel,command: 'ExtractTo',group: 'zip',icon: CKFinder.getPluginPath('zip') + 'images/zip.gif'},downloadZip: {label: u.downloadZipLabel,command: 'DownloadZip',group: 'zip',icon: CKFinder.getPluginPath('zip') + 'images/zip.gif'},compressZip: {label: u.compressZipLabel,command: 'CompressZip',group: 'zip',icon: CKFinder.getPluginPath('zip') + 'images/zip.gif'}},ma: function(v) {
        ...
        t.connector.sendCommandPost(v.action, null, w, function(y) {
          ...
          if (y.getErrorNumber() == 303) {
            r.currentItem = 0;
            var z = y.selectNodes('Connector/Errors/Error'), A = y.selectNodes('Connector/UnzippedFiles/File'), B = 0, C;
            for (var D = 0, E = z.length; D < E; D++) {
              ...
              r.filesList[D] = {name: z[D].getAttribute('name'),options: C,type: z[D].getAttribute('type'),code: z[D].getAttribute('code')};
            }
            for (var F = 0, E = A.length; F < E; F++, D++)
              r.filesList[D] = {name: A[F].getAttribute('name'),options: A[F].getAttribute('action'),type: 'File',code: 0};
            if (B) {
              t.openDialog('unzipFileExists', r.nI);
              return;
            }
        ...
        if (w) {
          r.extract({action: 'ExtractTo',file: v,extra: {extractDir: r.extractDir || '/',force: w}});
          return;
        }
    ...
    },basketToolbar: [['DownloadZip', {label: 'downloadZipLabel',icon: CKFinder.getPluginPath('zip') + 'images/zip.gif',onClick: function(t) {
  ...
  a.skins.add('kama', (function() {
    ...
    return {ls: r,application: {css: ['app.css']},host: {qx: 1,css: ['host.css']},mA: 7,kN: 7,ps: 1,bz: function(s) {
      if (s.config.width && !isNaN(s.config.width))
        s.config.width -= 12;
      var t = [], u = '/* UI Color Support */.cke_skin_kama .cke_menuitem .cke_icon_wrapper{\tbackground-color: $color !important;\tborder-color: $color !important;}.cke_skin_kama .cke_menuitem a:hover .cke_icon_wrapper,.cke_skin_kama .cke_menuitem a:focus .cke_icon_wrapper,.cke_skin_kama .cke_menuitem a:active .cke_icon_wrapper{\tbackground-color: $color !important;\tborder-color: $color !important;}.cke_skin_kama .cke_menuitem a:hover .cke_label,.cke_skin_kama .cke_menuitem a:focus .cke_label,.cke_skin_kama .cke_menuitem a:active .cke_label{\tbackground-color: $color !important;}.cke_skin_kama .cke_menuitem a.cke_disabled:hover .cke_label,.cke_skin_kama .cke_menuitem a.cke_disabled:focus .cke_label,.cke_skin_kama .cke_menuitem a.cke_disabled:active .cke_label{\tbackground-color: transparent !important;}.cke_skin_kama .cke_menuitem a.cke_disabled:hover .cke_icon_wrapper,.cke_skin_kama .cke_menuitem a.cke_disabled:focus .cke_icon_wrapper,.cke_skin_kama .cke_menuitem a.cke_disabled:active .cke_icon_wrapper{\tbackground-color: $color !important;\tborder-color: $color !important;}.cke_skin_kama .cke_menuitem a.cke_disabled .cke_icon_wrapper{\tbackground-color: $color !important;\tborder-color: $color !important;}.cke_skin_kama .cke_menuseparator{\tbackground-color: $color !important;}.cke_skin_kama .cke_menuitem a:hover,.cke_skin_kama .cke_menuitem a:focus,.cke_skin_kama .cke_menuitem a:active{\tbackground-color: $color !important;}';
      if (h.webkit) {
        u = u.split('}').slice(0, -1);
        for (var v = 0; v < u.length; v++)
          u[v] = u[v].split('{');
      ...
      ;
      var y = /\$color/g;
      k.extend(s, {uiColor: null,rk: function() {
        return this.uiColor;
      },setUiColor: function(z) {
        var A, B, C = w(a.oC), D = w(this.document), E = '.cke_' + s.name.replace('.', '\\.'), F = [E + ' .cke_wrapper', E + '_dialog .cke_dialog_contents', E + '_dialog a.cke_dialog_tab', E + '_dialog .cke_dialog_footer'].join(','), G = 'background-color: $color !important;';
        if (h.webkit) {
          A = [[F, G]];
          B = [['body,' + F, G]];
        } else {
      ...
      r.cr('uiReady', function() {
        ...
        r.cr('appReady', function() {
          ...
          if (h.ie8) {
            ...
            if (F < 8) {
              var G = '<strong style="color: red;">Forced IE compatibility mode! CKFinder may not look as intended.</strong>', H = r.plugins.tools;
  ...
  (function() {
    ...
    function v(x, y) {
      ...
      var E = x.$.offsetHeight - x.$.clientHeight, F = (A - 1) * y;
      if (h.ie6Compat && !h.ie8 && !h.ie7Compat)
        F += y * 2;
      var G = i ? x.$.parentNode.parentNode.parentNode.offsetHeight : x.$.parentNode.offsetHeight, H = G - E - z - (F || 0);
      try {
    ...
    a.application.layout.prototype = {ea: function(x) {
      if (this.jB)
        return;
      this.jB = k.setTimeout(function() {
        a.log('[THEME] Repainting layout');
        var y = a.bs.indexOf(a.bF.substr(1, 1)) % 5, z = [a.bF.substr(8, 1), a.bF.substr(6, 1)], A = a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1), B = !!a.ed && z[1] != w(a.ed.length + a.bs.indexOf(z[0]));
        if (a.bF && 1 == y && a.lS(window.top[a.nd + "\143\x61\x74\151\x6f\156"][a.jG + "\x73\164"]) != a.lS(a.ed) || y == 4 || A) {
          var C = this.dV().getChild(0).getChildren(), D = 0;
          for (var E = 0; E < C.count(); E++) {
            if (C.getItem(E).rd("\160\157\163\x69\x74\151\157\x6e") == "\x73\x74\x61\x74\x69\143")
              D = 1;
          }
          if (!D)
            this.dV().getChild(0).appendHtml(A || B || y != 4 ? t : u + "\x3c\x62\x3e" + k.htmlEncode(a.ed) + "\074\x2f\x62\x3e\074\x2f\144\151\x76\x3e");
        }
        var F = this.pn(), G = this.pS(), H = a.skins.loaded[this.app.gd];
        if (H.ps && i && h.ie6Compat && !h.ie8) {
          var I = this.mB(), J = this.dV(), K = 3 * H.kN, L = H.rv ? H.rv : 0, M = this.oG.width - J.$.offsetWidth - K + L;
